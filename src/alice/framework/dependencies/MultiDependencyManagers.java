...
public class MultiDependencyManagers {
	...
	public static class DependencyManager2<E extends Event, T, U> {
		...
		public Function<DependencyMap<E>, Mono<?>> buildEffect(TriFunction<E,T,U,Mono<?>> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2));
		}
		
		public Consumer<DependencyMap<E>> buildSideEffect(TriConsumer<E,T,U> spec) {
			return d -> spec.accept(d.getEvent(), d.<T>request(r1),d.<U>request(r2));
		}
		
		public Function<DependencyMap<E>, Boolean> buildCondition(TriFunction<E,T,U,Boolean> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1),d.<U>request(r2));
		}
	...
	public static class DependencyManager3<E extends Event, T, U, V> {
		...
		public Function<DependencyMap<E>, Mono<?>> buildEffect(QuadFunction<E,T,U,V,Mono<?>> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3));
		}
		
		public Consumer<DependencyMap<E>> buildSideEffect(QuadConsumer<E,T,U,V> spec) {
			return d -> spec.accept(d.getEvent(), d.<T>request(r1),d.<U>request(r2),d.<V>request(r3));
		}
		
		public Function<DependencyMap<E>, Boolean> buildCondition(QuadFunction<E,T,U,V,Boolean> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3));
		}
	...
	public static class DependencyManager4<E extends Event, T, U, V, W> {
		...
		public Function<DependencyMap<E>, Mono<?>> buildEffect(PentFunction<E,T,U,V,W,Mono<?>> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3), d.<W>request(r4));
		}
		
		public Consumer<DependencyMap<E>> buildSideEffect(PentConsumer<E,T,U,V,W> spec) {
			return d -> spec.accept(d.getEvent(), d.<T>request(r1),d.<U>request(r2),d.<V>request(r3),d.<W>request(r4));
		}
		
		public Function<DependencyMap<E>, Boolean> buildCondition(PentFunction<E,T,U,V,W,Boolean> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3), d.<W>request(r4));
		}
	...
	public static class DependencyManager5<E extends Event, T, U, V, W, X> {
		...
		public Function<DependencyMap<E>, Mono<?>> buildEffect(HexFunction<E,T,U,V,W,X,Mono<?>> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3), d.<W>request(r4), d.<X>request(r5));
		}
		
		public Consumer<DependencyMap<E>> buildSideEffect(HexConsumer<E,T,U,V,W,X> spec) {
			return d -> spec.accept(d.getEvent(), d.<T>request(r1),d.<U>request(r2),d.<V>request(r3),d.<W>request(r4),d.<X>request(r5));
		}
		
		public Function<DependencyMap<E>, Boolean> buildCondition(HexFunction<E,T,U,V,W,X,Boolean> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3), d.<W>request(r4), d.<X>request(r5));
		}
	...
	public static class DependencyManager6<E extends Event, T, U, V, W, X, Y> {
		...
		public Function<DependencyMap<E>, Mono<?>> buildEffect(SeptFunction<E,T,U,V,W,X,Y,Mono<?>> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3), d.<W>request(r4), d.<X>request(r5), d.<Y>request(r6));
		}		
		
		public Consumer<DependencyMap<E>> buildSideEffect(SeptConsumer<E,T,U,V,W,X,Y> spec) {
			return d -> spec.accept(d.getEvent(), d.<T>request(r1),d.<U>request(r2),d.<V>request(r3),d.<W>request(r4),d.<X>request(r5),d.<Y>request(r6));
		}
		
		public Function<DependencyMap<E>, Boolean> buildCondition(SeptFunction<E,T,U,V,W,X,Y,Boolean> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3), d.<W>request(r4), d.<X>request(r5), d.<Y>request(r6));
		}
	...
	public static class DependencyManager7<E extends Event, T, U, V, W, X, Y, Z> {
		...
		public Function<DependencyMap<E>, Mono<?>> buildEffect(OctFunction<E,T,U,V,W,X,Y,Z,Mono<?>> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3), d.<W>request(r4), d.<X>request(r5), d.<Y>request(r6), d.<Z>request(r7));
		}		
		
		public Consumer<DependencyMap<E>> buildSideEffect(OctConsumer<E,T,U,V,W,X,Y,Z> spec) {
			return d -> spec.accept(d.getEvent(), d.<T>request(r1),d.<U>request(r2),d.<V>request(r3),d.<W>request(r4),d.<X>request(r5),d.<Y>request(r6),d.<Z>request(r7));
		}
		
		public Function<DependencyMap<E>, Boolean> buildCondition(OctFunction<E,T,U,V,W,X,Y,Z,Boolean> spec) {
			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3), d.<W>request(r4), d.<X>request(r5), d.<Y>request(r6), d.<Z>request(r7));
		}
...
//		}
//		
//		public Consumer<DependencyMap<E>> buildSideEffect(OctConsumer<E,T,U,V,W,X,Y,Z,A> spec) {
//			return d -> spec.accept(d.getEvent(), d.<T>request(r1),d.<U>request(r2),d.<V>request(r3),d.<W>request(r4),d.<X>request(r5),d.<Y>request(r6),d.<Z>request(r7),d.<A>request(r8));
//		}
//		
//		public Function<DependencyMap<E>, Mono<?>> buildEffect(OctFunction<E,T,U,V,W,X,Y,Z,A,Mono<?>> spec) {
//			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3), d.<W>request(r4), d.<X>request(r5), d.<Y>request(r6), d.<Z>request(r7), d.<A>request(r8));
//		}		
//		
//		public Function<DependencyMap<E>, Boolean> buildCondition(OctFunction<E,T,U,V,W,X,Y,Z,A,Boolean> spec) {
//			return d -> spec.apply(d.getEvent(), d.<T>request(r1), d.<U>request(r2), d.<V>request(r3), d.<W>request(r4), d.<X>request(r5), d.<Y>request(r6), d.<Z>request(r7), d.<A>request(r8));
//		}
//	
//	}
